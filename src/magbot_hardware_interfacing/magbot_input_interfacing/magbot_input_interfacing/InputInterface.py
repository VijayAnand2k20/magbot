...
from magbot_control.Command import Command
from magbot_utilities.Utilities import deadband, clipped_first_order_filter
...
class InputInterface(Node):
    def __init__(self, config):
        ...
        self.input_messages = self.create_subscription(Joy, 'joy', self.input_callback, 10)
